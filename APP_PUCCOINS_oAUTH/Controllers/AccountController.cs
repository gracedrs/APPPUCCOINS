...
using APP_PUCCOINS_oAUTH_oAUTH.Models;
...
namespace APP_PUCCOINS_oAUTH_oAUTH.Controllers
{
    [Authorize]
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        string url = "https://apipuccoins.azurewebsites.net/api/Usuarios";

                        client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Basic", Convert.ToBase64String(System.Text.Encoding.ASCII.GetBytes(string.Format("{0}:{1}", "admin@puccoins.com.br", "1234"))));
                        ...
                        else
                        {
                            ...
                            erros[0] = "Erro ao salvar dados do Usuário.";
                            AddErrors(new IdentityResult(erros));
                            return View(model);
                        }
                    }
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    Usuario u = new Usuario
                    {
                        ...
                        Senha = loginInfo.Login.ProviderKey
                    };
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        string url = "https://apipuccoins.azurewebsites.net/api/GetUsuarioByEmail?email=" + loginInfo.Email;
                        ...
                        Session["UserProfile"] = usuarioPesquisado;
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        Usuario u = new Usuario();
                        u.Nome = info.DefaultUserName;
                        u.Senha = info.Login.ProviderKey;
                        u.Email = model.Email;
